        ...
        >
          <p className="flex justify-between md:item-center text-gray-400 md:font-medium max-md:flex-col">
            ...
            {order.items.map((item, index) => (
              <div key={index} className={`relative bg-white text-gray-500/70 ${order.items.length - 1 !== index && "border-b border-gray-200/30"} flex flex-col md:flex-row md:items-center justify-between p-4 py-5 md:gap-16 w-full max-w-4xl`}>
